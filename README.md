About pandoctools-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandoctools-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6107&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandoctools-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandoctools` can be installed with `conda`:
...
```
mamba install pandoctools
```

It is possible to list all of the versions of `pandoctools` available on your platform with `conda`:
...
```
mamba search pandoctools --channel conda-forge
```
...
mamba repoquery search pandoctools --channel conda-forge

# List packages depending on `pandoctools`:
mamba repoquery whoneeds pandoctools --channel conda-forge

# List dependencies of `pandoctools`:
mamba repoquery depends pandoctools --channel conda-forge
```
